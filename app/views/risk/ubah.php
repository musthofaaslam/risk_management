...
<?php
 var_dump($data['analisis']);
?>
                <input type="hidden" name="id" value="<?=$data['analisis'][0]['id'];?>">
                <div class="form-group">
                  <label for="tujuan" class="form-label">Tujuan</label>
                  <input type="text" class="form-control" id="tujuan" name="tujuan" value="<?=$data['analisis'][0]['tujuan'];?>">
                </div>
                <div class="form-group">
    ...
    <select class="form-select" id="risk_category" name="risk_category" aria-label="Default select example">
        ...
        <option value="keselamatan" <?php echo ($data['analisis'][0]['risk_category'] == 'keselamatan') ? 'selected' : ''; ?>>Keselamatan</option>
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="uraian_resiko" name="uraian_resiko" rows="3"><?=$data['analisis'][0]['tujuan'];?></textarea>
                </div>
                <div class="form-group">
                  <label for="penyebab_resiko" class="form-label">Penyebab resiko</label>
                  <textarea class="form-control" id="penyebab_resiko" name="penyebab_resiko" rows="3"><?=$data['analisis'][0]['penyebab_resiko'];?></textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="kerugian_kualitatif" name="kerugian_kualitatif" rows="3"><?=$data['analisis'][0]['penyebab_resiko'];?></textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="unit_terkait" name="unit_terkait" value="<?=$data['analisis'][0]['unit_terkait'];?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="trait_desc" name="trait_desc" rows="3"><?=$data['analisis'][0]['trait_desc'];?></textarea>
                </div>
                <div class="form-group">
