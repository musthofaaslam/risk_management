...
<form action="<?=BASEURL;?>/mitigasi/identifikasi" method="post">         
                <div class="form-group">
                <div class="row">
                <div class="col-md-12" >
                <label for="risk_event" class="form-label">Peristiwa</label>
                <input type="text" class="form-control" id="risk_event" name="risk_event" required autocomplete="off">
                </div>
                </div>
                </div>
                <!-- section -->
                ...
                <div class="col-md-6">
                  ...
                  <textarea class="form-control" id="rencana_mitigasi" name="rencana_mitigasi" rows="3" required autocomplete="off"></textarea>
                </div>
                <div class="col-md-6">
                  <label for="evidence" class="form-label">Bukti</label>
                  <textarea class="form-control" id="evidence" name="evidence" rows="3" required autocomplete="off"></textarea>
                </div>
                </div>
                </div>
